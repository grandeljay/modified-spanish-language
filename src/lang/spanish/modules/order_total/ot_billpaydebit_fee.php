...
define($prefix . 'FEE_TITLE', 'Recargo por método de pago domiciliación bancaria (BillPay)');
define($prefix . 'FEE_DESCRIPTION', 'Cálculo de la tasa para pedidos con el método de pago domiciliado (BillPay)');
