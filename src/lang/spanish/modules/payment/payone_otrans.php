...
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_TITLE', 'Transferencia bancaria en línea');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_DESCRIPTION', 'Pago por transferencia en línea a través de PayOne');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_INFO', 'Pago por transferencia bancaria en línea');
