...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_TITLE', 'BillPay - Débito directo');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_DESCRIPTION', 'BillPay - Débito directo');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO1', 'Gracias por elegir pagar mediante domiciliación bancaria con BillPay.');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_INVOICE_INFO2', 'En los próximos días cargaremos el importe adeudado en la cuenta especificada en el pedido.');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO1', 'Para este pedido por domiciliación bancaria se aplicará una tasa de ');
define('MODULE_PAYMENT_BILLPAYDEBIT_TEXT_FEE_INFO2', ' elevado');
...
define('MODULE_PAYMENT_BILLPAYDEBIT_THANK_YOU_TEXT', 'Gracias por elegir BillPay Direct Debit al comprar la mercancía.');
define('MODULE_PAYMENT_BILLPAYDEBIT_PAY_UNTIL_TEXT', 'En los próximos días cargaremos el importe de %1$s %2$s en la cuenta especificada en el pedido.');
define('MODULE_PAYMENT_BILLPAYDEBIT_EMAIL_TEXT', 'BillPay le informará con antelación de la fecha de cobro por correo electrónico.');
